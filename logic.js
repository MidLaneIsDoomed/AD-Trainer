...
const champions = [
    ...
    //saknades
    { name: "Alistar", type: "AP"},
    { name: "Ambessa", type: "AD"},
    { name: "Amumu", type: "AP"},
    { name: "Aurora", type: "AP"},
    { name: "Braum", type: "AP"},
    { name: "Briar", type: "AD"},
    ...
    { name: "Lillia", type: "AP"},
    { name: "Lulu", type: "AP"},
    { name: "Malphite", type: "AP"},
    { name: "Mel", type: "AP"},
    { name: "Milio", type: "AP"},
    { name: "Naafiri", type: "AD"},
    { name: "Nami", type: "AP"},
    { name: "Nasus", type: "AD"},
    { name: "Neeko", type: "AP"},
    { name: "Nocturne", type: "AD"},
    { name: "Ornn", type: "AP"},
    { name: "Quinn", type: "AD"},
    { name: "Renataglasc", type: "AP"},
    { name: "Rengar", type: "AD"},
    { name: "Rell", type: "AP"},
    { name: "Ryze", type: "AP"},
    { name: "Sejuani", type: "AP"},
    { name: "Seraphine", type: "AP"},
    { name: "Sivir", type: "AD"},
    { name: "Smolder", type: "AD"},
    { name: "Sona", type: "AP"},
    { name: "Soraka", type: "AP"},
    { name: "Swain", type: "AP"},
    { name: "Sylas", type: "AP"},
    { name: "Taric", type: "AP"},
    { name: "Tryndamere", type: "AD"},
    { name: "TwistedFate", type: "AP"},
    { name: "Velkoz", type: "AP"},
    { name: "Viego", type: "AD"},
    { name: "XinZhao", type: "AD"},
    { name: "Yorick", type: "AD"},
    { name: "Yunara", type: "AD"},
    { name: "Zaheen", type: "AD"}
  ];
